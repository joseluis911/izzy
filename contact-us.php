...
<body class="sections-page sidebar-collapse">
  ...
  <div class="page-header header-filter" data-parallax="true" style="background-image: url('./assets/img/contact.jpg');">
    <div class="container" id="itservices">
      <div class="row">
        <div class="col-md-8 ml-auto mr-auto text-center">
          <h1 class="title">Contact Us</h1>
          <h4> We'll get in touch with you as soon as possible.</h4>
          <br>
        </div>
      </div>
    </div>
      ...
      <div class="section section-text">
        <div class="row">
          ...
          <div class="col-md-8 ml-auto mr-auto">
            <br>
            <div class="card card-contact" id="contact-us">
